...
// Set these to your home WiFi so ESP32 has internet + dashboard at same time
const char *const TB_STA_SSID = "MEMO11";       // Your home WiFi name (leave empty to skip STA)
const char *const TB_STA_PASSWORD = "01111631233Eng";   // Your home WiFi password
