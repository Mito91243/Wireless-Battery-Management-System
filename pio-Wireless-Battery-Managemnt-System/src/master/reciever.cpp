...
// Arduino-ESP32 crt_bundle didn't link into this build (runtime
// "Failed to attach bundle"). This single root covers wbms.systems and
// every other LE-issued cert.
